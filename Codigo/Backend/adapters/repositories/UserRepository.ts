import { Usuario } from "../../application/model/UsuarioModel";
import { IUserRepository } from "../../application/interface/IUserRepository";
import sql from "../config/database";
 import { v4 as uuidv4 } from "uuid"
import bcrypt from "bcrypt";
import { AgenteModel } from "../../application/model/AgenteModel";
import { Cliente } from "../../application/model/ClienteModel";
